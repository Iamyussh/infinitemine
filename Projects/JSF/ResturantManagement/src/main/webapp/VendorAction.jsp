...
<html>
    ...
    <body>
        ...
        <h:dataTable value="#{orderList}" var="e" border="5">
                ...
                <h:column>
        	           <f:facet name="header">
        	           		<h:outputText value="Vendor Accept" />
        	           </f:facet>
                    <h:commandButton action="#{ordersDao.acceptOrder(e.ordid)}" value="Accept" />
                </h:column>
                
                <h:column>
        	           <f:facet name="header">
        	           		<h:outputText value="Vendor Reject" />
        	           </f:facet>
                    <h:commandButton action="#{ordersDao.rejectOrder(e.ordid)}" value="Reject" />
                </h:column>
