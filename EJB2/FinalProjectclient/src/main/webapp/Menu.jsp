...
<h:form>
    <nav>
        <div class="logo-name">
            ...
            <span class="logo_name">Admin Ayush</span>
        </div>
        ...
        <div class="menu-items">
            ...
            <a href="">Patient Medical History</a>
                ...
                <div class="dropdown-content">
                <a href="InsuranceDetailsPagination.jsf">Create Insurance</a>
            ...
            <ul class="logout-mode">
                <li><h:commandLink action="#{insuranceDetailsdao.logout()}"> <i class="uil uil-signout"></i> <span
            ...
            <div class="overview">
             ...
             <div class="activity">
                ...
                <div class="activity-data">
                    ...
                    <img src="Dr.jpg" style="width:300px; height:200px">
                    
                    <span class="data-list">Name: Rahul</span>
