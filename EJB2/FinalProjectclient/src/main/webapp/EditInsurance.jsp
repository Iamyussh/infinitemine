...
.form-group select, .form-group2 select, .form-group input, .form-group2 input
	{
	width: 19%%;
	padding: 10px;
	margin-bottom: 15px;
...
.form-group select:hover, .form-group2 select:hover, .form-group input:hover,
...
<body>
	...
	<h:form id="form">
		...
		<h:inputText id="pstart1" value="#{insuranceFound.insuranceId}"
			readonly="true" style="width:88px;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <h:outputText value="Premium End" styleClass="en"/>
		...
		<br>
		<h:message for="pstart" style="color:red;" styleClass="stmsg"/>

		<h:message for="pend"
			style="color: red; position: fixed; right: 350px;" />
		<br>
			
		
	
		<h:commandButton id="addbutton"
			action="#{insuranceController.updateInsurancedetail(insuranceFound)}"
			value="Save Changes" styleClass="save-button" />
