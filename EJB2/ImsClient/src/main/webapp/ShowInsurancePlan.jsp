...
<body>
	<h:form>
		...
		<h:dataTable value="#{insuranceplandao.showPlans(insuranceid)}" var="e"
			border="3">
			<h:column>
				<f:facet name="header">
			...
			<h:column>
				...
				<h:commandButton action="#{customerpolicydaoimpl.redirectTotakePolicy(e.planid,e.premiumamt)}" value="Take Policy" />
			</h:column>
