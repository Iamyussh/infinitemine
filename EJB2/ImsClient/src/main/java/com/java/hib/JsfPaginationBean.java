...
public class JsfPaginationBean {
	...
	private List<CustomerDetails> cdList;
	private CustomerDetailsDAOImpl queryHelper;
	/**
	 * pagination stuff
	 */
	...
	public JsfPaginationBean() {
		queryHelper = new CustomerDetailsDAOImpl();
		/**
	...
	public void setCdList(List<CustomerDetails> cdList) {
		this.cdList = cdList;
	}
	...
	private void loadCustomerDetails() {
		...
		cdList = queryHelper.getListOfCustomerDetails(firstRow, rowsPerPage);
