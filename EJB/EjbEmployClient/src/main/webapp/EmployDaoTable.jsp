        ...
        <center>
                ...
                <h:column>
                    ...
                    <h:commandButton action="#{ejbImpl.searchEmployEjb(e.empno)}" 
                    	value="Search" styleClass="search-button"/>
                </h:column>
                 <h:column>
                <f:facet name="header">
                <h:outputLabel value="Delete" />
                </f:facet>
                <h:commandButton styleClass="delete-button" action="#{ejbImpl.deleteEmployEjb(e.empno)}" value="Delete" />
                </h:column>
                
        </h:dataTable>
        </center>
                <center>
        <h:commandButton action="CreateEmploy.jsp?faces-redirect=true"	styleClass="add-button"
        	 value="Add Employ" /> 
