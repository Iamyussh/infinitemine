<%@page import="com.java.jspbeans.Gender"%>
<%@page import="com.java.jspbeans.Employ"%>
<%@page import="com.java.jspbeans.EmployDAOImpl"%>
<%@page import="com.java.jspbeans.EmployDAO"%>
