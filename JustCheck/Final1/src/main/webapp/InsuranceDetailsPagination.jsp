...
body {
    ...
    margin: 0;
    padding: 0;
    background-image: url('ins.jpg'); /* Replace 'your-image-url.jpg' with the path to your background image */
...
@keyframes l9 {
  to {transform:perspective(300px) translateZ(100px);opacity:0}
    ...
    <body>
        ...
        <h:dataTable value="#{paginationDao.getInsuranceList()}" var="e" border="2" styleClass="my-datatable">
        	    <h:column>
                    <f:facet name="header">
		<h:outputLabel value="Insurance Id">
   		 <h:commandLink action="#{insuranceDetailsdao.sortorderById()}"  style="text-decoration:none">
   		 &nbsp; &nbsp;<div style="display: inline-flex;"><p>&#x25B2;</p> &nbsp;<p>&#x25BC;</p></div>
      	</h:commandLink>
                    </h:outputLabel>
    		</f:facet>
