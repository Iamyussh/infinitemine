	...
	public boolean addinsurancevalidate(InsuranceDetails insurancedetailsnew) {
		...
		boolean flag=true;
		 ...
		 if (insurancedetailsnew.getInsuranceName().equals(null)|| insurancedetailsnew.getInsuranceName().length() < 5) {
		        context.addMessage("form:iname", new FacesMessage(
						FacesMessage.SEVERITY_ERROR,"Insurance name must contain at least 5 characters",null));
		        flag= false;
		    }
		 
		 if (insurancedetailsnew.getType().equals(null)) {
		        context.addMessage("form:type", new FacesMessage(
						FacesMessage.SEVERITY_ERROR,"Insurance name must contain at least 5 characters",null));
		        flag= false;
		    }
		 ...
		 if (insurancedetailsnew.getPremiumStart()==null) {
	        	...
	        	context.addMessage("form:pstart", new FacesMessage(
						FacesMessage.SEVERITY_ERROR,"Please enter the start date",null));
	        	flag= false;
		 ...
		 if (insurancedetailsnew.getPremiumEnd()==null) {
	        	...
	        	context.addMessage("form:pend", new FacesMessage(
						FacesMessage.SEVERITY_ERROR,"Please enter the end date",null));
	        	flag= false;
		 ...
		 if (insurancedetailsnew.getLaunchDate()==null) {
	        	...
	        	context.addMessage("form:ldate", new FacesMessage(
		 ...
		 if (insurancedetailsnew.getStatus().equals(null)) {
		        	...
		        	context.addMessage("form:status", new FacesMessage(
